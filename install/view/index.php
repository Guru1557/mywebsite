...
<div class="modal fade in" data-keyboard="false" data-backdrop="static" id="InstallationModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">This box will disappear in <span id="timer">10</span> second</h4> 
      </div>
...
<div class="modal fade in" data-keyboard="false" data-backdrop="static" id="CompleteModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">This box will disappear in <span id="timer">10</span> second</h4>
